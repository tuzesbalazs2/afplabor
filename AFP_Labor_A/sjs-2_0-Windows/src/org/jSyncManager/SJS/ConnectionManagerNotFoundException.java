...
//~ ===========================================================================
/** 
 * The ConnectionManagerNotFoundException class. Instances of this class
 * are thrown when a ServerRemoteInterface instance are unable to find the
 * requested service.
 *
 * @author Brad BARCLAY &lt;bbarclay@jsyncmanager.org&gt;
 * @version 0.1
 */
public class ConnectionManagerNotFoundException extends Exception {
//~  ========================================================================
   ...
   public ConnectionManagerNotFoundException() {
      super();
   }   // end ConnectionManagerNotFoundException()
...
// ---------------------------------------------------------------------------
   /** Constructs a new ConnectionManagerNotFoundException with the specified message.
     ...
     */
   public ConnectionManagerNotFoundException(String msg) {
      super(msg);
   }   // end ConnectionManagerNotFoundException()
