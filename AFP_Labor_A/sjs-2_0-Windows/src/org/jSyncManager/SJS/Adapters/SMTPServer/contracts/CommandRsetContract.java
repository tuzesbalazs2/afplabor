...
import org.jSyncManager.SJS.Adapters.SMTPServer.AbstractSMTPServer.CommandRset;
 ...
 * @see CommandRset
 */
public class CommandRsetContract extends ContractBase<CommandRset> {
...
/** 
    ...
    */
   public CommandRsetContract(CommandRset t) {
	   super(t);
   }   // end CommandRsetContract()
   ...
   public void classInvariant() {
      assert "RSET".equalsIgnoreCase(((String)super.getTargetField("cmd")));
   }   // end classInvariant()
}   // end CommandRsetContract
