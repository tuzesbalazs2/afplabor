 ...
 * @see CommandEhlo
 */
public class CommandEhloContract extends ContractBase<CommandEhlo> {
...
/** 
    ...
    */
   public CommandEhloContract(CommandEhlo t) {
	   super(t);
   }   // end CommandEhloContract()
   ...
   public void classInvariant() {
      assert "EHLO".equalsIgnoreCase(((String)super.getTargetField("cmd")));
   }   // end classInvariant()
}   // end CommandEhloContract
