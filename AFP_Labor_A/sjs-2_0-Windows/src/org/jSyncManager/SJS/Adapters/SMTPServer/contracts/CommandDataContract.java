...
import org.jSyncManager.SJS.Adapters.SMTPServer.AbstractSMTPServer.CommandData;
 ...
 * @see CommandData
 */
public class CommandDataContract extends ContractBase<CommandData> {
...
/** 
    ...
    */
   public CommandDataContract(CommandData t) {
      super(t);
   }   // end CommandDataContract()
   ...
   public void classInvariant() {
      assert "DATA".equalsIgnoreCase(((String)super.getTargetField("cmd")));
   }   // end classInvariant()

   /** 
    * These conditions must be true before running the processNextData
    * method
    *
    * @param data The parameter to the method
    *
    * @see CommandData#processNextData(String)
    */
   public void pre_processNextData(String data) {
      assert data != null;
   }   // end pre_processNextData()
}   // end CommandDataContract
