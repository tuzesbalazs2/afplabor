...
import org.jSyncManager.SJS.Adapters.SMTPServer.AbstractSMTPServer.CommandMail;
 ...
 * @see CommandMail
 */
public class CommandMailContract extends ContractBase<CommandMail> {
...
/** 
    ...
    */
   public CommandMailContract(CommandMail t) {
	   super(t);
   }   // end CommandMailContract()
   ...
   public void classInvariant() {
      assert "MAIL".equalsIgnoreCase(((String)super.getTargetField("cmd")));
   }   // end classInvariant()
}   // end CommandMailContract
