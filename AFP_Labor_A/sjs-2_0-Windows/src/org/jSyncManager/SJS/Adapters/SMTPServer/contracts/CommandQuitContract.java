...
import org.jSyncManager.SJS.Adapters.SMTPServer.AbstractSMTPServer.CommandQuit;
 ...
 * @see CommandQuit
 */
public class CommandQuitContract extends ContractBase<CommandQuit> {
...
/** 
    ...
    */
   public CommandQuitContract(CommandQuit t) {
	   super(t);
   }   // end CommandQuitContract()
   ...
   public void classInvariant() {
      assert "QUIT".equalsIgnoreCase(((String)super.getTargetField("cmd")));
   }   // end classInvariant()
}   // end CommandQuitContract
