...
import org.jSyncManager.SJS.Adapters.SMTPServer.AbstractSMTPServer.CommandExpn;
 ...
 * @see CommandExpn
 */
public class CommandExpnContract extends ContractBase<CommandExpn> {
...
/** 
    ...
    */
   public CommandExpnContract(CommandExpn t) {
	   super(t);
   }   // end CommandExpnContract()
   ...
   public void classInvariant() {
      assert "EXPN".equalsIgnoreCase(((String)super.getTargetField("cmd")));
   }   // end classInvariant()
}   // end CommandExpnContract
