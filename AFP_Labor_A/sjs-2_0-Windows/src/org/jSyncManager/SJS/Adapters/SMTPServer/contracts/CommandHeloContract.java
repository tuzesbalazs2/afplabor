...
import org.jSyncManager.SJS.Adapters.SMTPServer.AbstractSMTPServer.CommandEhlo;
import org.jSyncManager.SJS.Adapters.SMTPServer.AbstractSMTPServer.CommandHelo;
 ...
 * @see CommandHelo
 */
public class CommandHeloContract extends ContractBase<CommandHelo> {
...
/** 
    ...
    */
   public CommandHeloContract(CommandEhlo t) {
	   super(t);
   }   // end CommandHeloContract()
   ...
   public void classInvariant() {
      assert "HELO".equalsIgnoreCase(((String)super.getTargetField("cmd")));
   }   // end classInvariant()
}   // end CommandHeloContract
